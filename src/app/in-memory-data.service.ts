...
export class InMemoryDataService implements InMemoryDbService {
    createDb() {
      ...
      const teams = [
        {id: 0, name: "team0", rating: [0,4,8,12,16]},
        {id: 1, name: "team1", rating: [1,5,9,13,17]},
        {id: 2, name: "team2", rating: [2,6,10,14,18]},
        {id: 3, name: "team3", rating: [3,7,11,15,19]},
        // {id: 4, name: "team4", rating: [0]},
